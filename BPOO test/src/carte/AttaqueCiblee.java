...
import joueur.Heros;
/**
 *Cette capacité permet à la carte qui la possède d'attaquer une cible,
 * soit le héros, soit l'un de ses serviteurs.
 * Cette capacité est sensible à la provocation
 * @author agathe
 *
 */
